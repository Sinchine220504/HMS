...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="<?php echo e(config('app.url') . 'storage/' . $settings["icon"]); ?> " type="image/x-icon" />
        ...
        <div class="header-top wow fadeIn">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img
                        src="<?php echo e(config('app.url') . 'storage/' . $settings["logo"]); ?>"
                        alt="logo image "></a>
                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:<?php echo e($settings["phone"] ?? '123 123 123'); ?>"><?php echo e($settings["phone"] ?? '123 123 123'); ?></a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:<?php echo e($settings["email"] ?? 'tauseed@test.com'); ?>"><?php echo e($settings["email"] ?? 'tauseed@test.com'); ?></a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll href="#">Daily:
                                    <?php echo e($settings["working_horse"] ?? '7:00 AM - 8:00 PM'); ?></a></span>
                        </div>
                    </div>
                </div>
            </div>
...
} elseif ($_instance->childHasBeenRendered('98O951Q')) {
    $componentId = $_instance->getRenderedChildComponentId('98O951Q');
    $componentTag = $_instance->getRenderedChildComponentTagName('98O951Q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('98O951Q');
} else {
    $response = \Livewire\Livewire::mount('search');
    $html = $response->html();
    $_instance->logRenderedChild('98O951Q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e('storage/'.$settings["logo"] ??  config("app.url").'images/logo.png'); ?>"
                                alt=""></a>
                        <p><?php echo e($settings["description"] ?? 'hi this isLocavore pork belly scen ester pine est chill wave microdosing pop uple itarian cliche artisan.'); ?>
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i><?php echo e($settings["address"] ?? 'distric abc P/O xyz sorana'); ?>

                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i><?php echo e($settings["email"] ?? 'tauseed@test.com'); ?>

                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i><?php echo e($settings["phone"] ?? '123 123 123'); ?></p>
                    </div>
                </div>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('subscribe')->html();
} elseif ($_instance->childHasBeenRendered('GcRF4qh')) {
    $componentId = $_instance->getRenderedChildComponentId('GcRF4qh');
    $componentTag = $_instance->getRenderedChildComponentTagName('GcRF4qh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GcRF4qh');
} else {
    $response = \Livewire\Livewire::mount('subscribe');
    $html = $response->html();
    $_instance->logRenderedChild('GcRF4qh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
    ...
    <script src="<?php echo e(asset('js/all-in-one.js')); ?>"></script>
    <!-- all plugins -->
...
<?php /**PATH C:\Users\SINCHINE DAS\OneDrive\Desktop\first\hospitalMS\resources\views/layouts/app.blade.php ENDPATH**/ ?>