...
<div id="home" class="parallax first-section wow fadeIn" data-stellar-background-ratio="0.4" style="background-image:url('images/slider-bg.png');" <?php echo e($app = App\Models\settings::latest()->first()); ?>>
   <div class="container">
      <div class="row">
...
} elseif ($_instance->childHasBeenRendered('mR8JSF0')) {
    $componentId = $_instance->getRenderedChildComponentId('mR8JSF0');
    $componentTag = $_instance->getRenderedChildComponentTagName('mR8JSF0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mR8JSF0');
} else {
    $response = \Livewire\Livewire::mount('appointmentform');
    $html = $response->html();
    $_instance->logRenderedChild('mR8JSF0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
...
} elseif ($_instance->childHasBeenRendered('3j4BhB5')) {
    $componentId = $_instance->getRenderedChildComponentId('3j4BhB5');
    $componentTag = $_instance->getRenderedChildComponentTagName('3j4BhB5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3j4BhB5');
} else {
    $response = \Livewire\Livewire::mount('contactus');
    $html = $response->html();
    $_instance->logRenderedChild('3j4BhB5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SINCHINE DAS\OneDrive\Desktop\first\hospitalMS\resources\views/index.blade.php ENDPATH**/ ?>